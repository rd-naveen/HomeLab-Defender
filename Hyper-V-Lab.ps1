...
function CreateAndConfigureVM {
    ...
    $vm_ = New-VM -Name $vm_name -MemoryStartupBytes $RamSize -NewVHDPath $virtual_hdd_loc\$vm_name.vhdx -NewVHDSizeBytes $StorageSize  -Generation 2 
...
createandconfigurevm -vmname "Lab-Ubuntu"  -category "linux"  -isofilelocation $ubuntu_iso   -interfacecount "2"  -ramsize $gb_4   -storagesize $gb_80 
